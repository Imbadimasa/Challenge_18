...
input_sender = st.text_input("Please enter your name")

# @TODO:
# Add an input area where you can get a value for `receiver` from the user.
input_receiver = st.text_input("Please enter the receiver's name")


# @TODO:
# Add an input area where you can get a value for `amount` from the user.
input_amount = st.text_input("Please enter the amount you want to send")
